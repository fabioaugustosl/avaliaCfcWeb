...
apoioApp.controller('AlunoPesquisarController', 
	function ($scope, $rootScope, $routeParams, $sessionStorage, notify, moment, alunoService, aulaService, cfcService, dashboardService){
		...
		var callbackListarDashAula= function(resultado){
			...
			console.log(alunoCtrl.graficoMediaPorAula);
